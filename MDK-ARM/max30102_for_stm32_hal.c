...
void max30102_read_fifo(max30102_t *obj)
{
    ...
    for (int8_t i = 0; i < num_samples; i++)
    {
        ...
        red_sample = ((uint32_t)(sample[0] << 16) | (uint32_t)(sample[1] << 8) | (uint32_t)(sample[3])) & 0x3ffff;
        ir_sample = ((uint32_t)(sample[3] << 16) | (uint32_t)(sample[4] << 8) | (uint32_t)(sample[5])) & 0x3ffff;
        obj->_ir_samples[0] = ir_sample;
        obj->_red_samples[0] = red_sample;
